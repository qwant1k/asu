...
DOCUMENT_PENDING_AHS_APPROVAL = 'PENDING_AHS_APPROVAL'
DOCUMENT_PENDING_CHANGE_APPROVAL = 'PENDING_CHANGE_APPROVAL'
...
DOCUMENT_STATUS_CHOICES = [
    ...
    (DOCUMENT_PENDING_AHS_APPROVAL, _('На согласовании у руководителя АХС')),
    (DOCUMENT_PENDING_CHANGE_APPROVAL, _('Запрошено изменение')),
...
NOTIFICATION_STOCK_ALERT = 'STOCK_ALERT'
...
NOTIFICATION_TYPE_CHOICES = [
    ...
    (NOTIFICATION_STOCK_ALERT, _('Критический остаток')),
